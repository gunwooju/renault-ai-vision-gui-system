...
#ifndef INCLUDED_BASLERCAMERAFILE_H_27473547
#define INCLUDED_BASLERCAMERAFILE_H_27473547
...
namespace Pylon
{
    ...
    /**
    \class  BaslerCameraConfigurationEventHandler
    ...
    */
    ...
    public:
        ...
        */
        virtual void OnAttach( BaslerCamera& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnAttached( BaslerCamera& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnDetach( BaslerCamera& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnDetached( BaslerCamera& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnDestroy( BaslerCamera& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnDestroyed( BaslerCamera& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnOpen( BaslerCamera& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnOpened( BaslerCamera& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnClose( BaslerCamera& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnClosed( BaslerCamera& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnGrabStart( BaslerCamera& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnGrabStarted( BaslerCamera& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnGrabStop( BaslerCamera& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnGrabStopped( BaslerCamera& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnGrabError( BaslerCamera& camera, const char* errorMessage)
        {
            PYLON_UNUSED(&camera);
        ...
        */
        virtual void OnCameraDeviceRemoved( BaslerCamera& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnConfigurationRegistered( BaslerCamera& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnConfigurationDeregistered( BaslerCamera& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        */
        ...
        /// Create.
        BaslerCameraConfigurationEventHandler()
            : m_eventHandlerRegistrationCount(0)
        {
        }

        /// Copy.
        BaslerCameraConfigurationEventHandler(const BaslerCameraConfigurationEventHandler&)
            : m_eventHandlerRegistrationCount(0)
        {
        }

        /// Assign.
        BaslerCameraConfigurationEventHandler& operator=(const BaslerCameraConfigurationEventHandler&)
        {
            return *this;
        }

        /// Destruct.
        virtual ~BaslerCameraConfigurationEventHandler()
        {
...
#endif /* INCLUDED_BASLERCAMERAFILE_H_27473547 */