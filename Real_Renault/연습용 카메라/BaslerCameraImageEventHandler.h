...
#ifndef INCLUDED_BASLERCAMERAFILE_H_23893489
#define INCLUDED_BASLERCAMERAFILE_H_23893489
...
namespace Pylon
{
    ...
    /**
    \class  BaslerCameraImageEventHandler
    ...
    */
    ...
    public:
        ...
        */
        virtual void OnImagesSkipped( BaslerCamera& camera, size_t countOfSkippedImages)
        {
            PYLON_UNUSED(&camera);
        ...
        \threading
            This method is called outside the lock of the camera object but inside the lock of the image event handler registry.
        */
        virtual void OnImageGrabbed( BaslerCamera& camera, const BaslerCameraGrabResultPtr& grabResult)
        {
            PYLON_UNUSED(&camera);
        ...
        */
        virtual void OnImageEventHandlerRegistered( BaslerCamera& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the image event handler registry.
        */
        virtual void OnImageEventHandlerDeregistered( BaslerCamera& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        */
        ...
        /// Copy.
        BaslerCameraImageEventHandler(const BaslerCameraImageEventHandler&)
            : m_eventHandlerRegistrationCount(0)
        {
        }

        /// Assign.
        BaslerCameraImageEventHandler& operator=(const BaslerCameraImageEventHandler&)
        {
            return *this;
        }

        /// Destruct.
        virtual ~BaslerCameraImageEventHandler()
        {
...
#endif /* INCLUDED_BASLERCAMERAFILE_H_23893489 */